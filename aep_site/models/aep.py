...
from aep_site.jinja.ext.sample import SampleExtension
...
class AEP:
    ...
    def content(self) -> md.MarkdownDocument:
        ...
        # Hotlink AEP references.
        # We can (now) link to AEPs outside of general, those that are numbered
